...
const WizardStepIndicator: FC<IWizardStepIndicator> = ({
	stepId,
	step,
	onStepClicked = () => [],
}) => {
	...
	return (
		...
		>
			<span className="flex items-center">
				{isAchieved ? <CheckIcon /> : <span className="mr-2">{stepId}.</span>}
				{name}
			</span>
		</li>
	);
...
export const WizardStepperHeader: FC<IWizardStepperHeader> = ({
	stepNames,
}) => {
