...
import {Button, ButtonSize, ButtonVariant, Form, PasswordField, Section, TextField} from "../../../components";
...
const MemberLogin = () => {
	...
	const onAuthenticate = async ({ email, password }: { email: string; password: string }) => {
		try {
